...
// Temporarily forcing production mode to fix signup issues
const isDevelopment = false; // Changed from: !forceProduction && (import.meta.env.DEV || window.location.hostname === 'localhost');
